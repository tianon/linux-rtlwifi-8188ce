...
#define IS_92D_SINGLEPHY(version)    	((version & CHIP_92D_SINGLEPHY) ? true : false)
#define IS_92D_C_CUT(version)     		((version & CHIP_92D_C_CUT) ? true : false)
#define IS_92D_D_CUT(version)     		((version & CHIP_92D_D_CUT) ? true : false)
